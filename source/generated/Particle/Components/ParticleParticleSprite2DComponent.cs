...
public partial class ParticleEntity {
    ...
    public void AddParticleSprite2D(int newSpriteId, KMath.Vec2f[] newVertices, KMath.Vec2f[] newTextureCoords, int newTextureLayer, KMath.Vec2f newSize) {
    ...
    public void ReplaceParticleSprite2D(int newSpriteId, KMath.Vec2f[] newVertices, KMath.Vec2f[] newTextureCoords, int newTextureLayer, KMath.Vec2f newSize) {
        var index = ParticleComponentsLookup.ParticleSprite2D;
        var component = (Particle.Sprite2DComponent)CreateComponent(index, typeof(Particle.Sprite2DComponent));
        component.SpriteId = newSpriteId;
        component.Vertices = newVertices;
