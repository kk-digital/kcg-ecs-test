...
public partial class VehicleEntity {
    ...
    public void AddVehicleSprite2D(int newSpriteId, int newThrusterSpriteId, int newWidth, int newHeight, Sprites.TexCoords newCoords) {
    ...
    public void ReplaceVehicleSprite2D(int newSpriteId, int newThrusterSpriteId, int newWidth, int newHeight, Sprites.TexCoords newCoords) {
        var index = VehicleComponentsLookup.VehicleSprite2D;
        var component = (Vehicle.Sprite2DComponent)CreateComponent(index, typeof(Vehicle.Sprite2DComponent));
        component.SpriteId = newSpriteId;
        component.ThrusterSpriteId = newThrusterSpriteId;
